...
public class TravelInsurancePage extends BasePage {
	...
	/**
	 * Clicks the Explore Plans button.
	 */
	public boolean isExplorePlanButtonClickable() {
		return isElementClickable(explorePlansButton);
	}
	public void exploreButton() {
		explorePlansButton.click();
	}
